...
//	load_material(scene);
	material.load_material(scene, has_tex, filename);
	assign_vao(scene);
...
{
	TwAddVarRW(bar, vao+"    ETA", TW_TYPE_COLOR3F, &material.eta, " step = 0.05 ");
	TwAddVarRW(bar, vao+"    Reflectiveness", TW_TYPE_FLOAT, &material.reflection, " step = 0.05 ");
